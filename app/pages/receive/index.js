...
module.exports = function(el){
  ...
  ractive.on('help', function() {
    showTooltip({
      message: 'Waggle lets you broadcast your wallet address to other nearby Obsidiancvt users by comparing GPS data. This data is deleted once you turn Waggle off.'
    })
  })
